...
const localPath = path.join(
  __dirname,
  `npm/${packageName}/intl-flat-json-parser.${packageName}.node`,
);
const packagePath = `@discord/intl-flat-json-parser-${packageName}`;
const nativeBinding = fs.existsSync(localPath) ? require(localPath) : require(packagePath);

const { parseJson, parseJsonFile } = nativeBinding;
